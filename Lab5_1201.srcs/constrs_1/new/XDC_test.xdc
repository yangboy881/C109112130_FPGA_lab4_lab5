...
set_property IOSTANDARD LVCMOS33 [get_ports IN_right_btn]
set_property IOSTANDARD LVCMOS33 [get_ports IN_left_btn]
set_property IOSTANDARD LVCMOS33 [get_ports Sel_CH_btn]
set_property IOSTANDARD LVCMOS33 [get_ports Sel_IN_btn]

set_property PACKAGE_PIN U5 [get_ports IN_left_btn]
set_property PACKAGE_PIN V5 [get_ports Sel_IN_btn]
set_property PACKAGE_PIN W7 [get_ports Rout]
set_property PACKAGE_PIN W6 [get_ports H]
set_property PACKAGE_PIN V7 [get_ports V]
set_property PACKAGE_PIN U6 [get_ports IN_right_btn]
set_property PACKAGE_PIN W5 [get_ports Gout]
set_property PACKAGE_PIN U7 [get_ports Bout]
set_property PACKAGE_PIN V4 [get_ports Sel_CH_btn]
