...
architecture behaviour1 of VGAdrive is
  ...
  constant B : natural := 93;  -- horizontal blank(水平空白): 3.77 us
  constant C : natural := 45;  -- front guard(前衛): 1.89 us
  constant D : natural := 640; -- horizontal columns(橫列): 25.17 us
  constant E : natural := 22;  -- rear guard(後衛): 0.94 us
  constant A : natural := B + C + D + E;  -- one horizontal(一橫) sync cycle: 31.77 us
  constant P : natural := 2;   -- vertical blank(垂直空白): 64 us
  constant Q : natural := 32;  -- front guard: 1.02 ms
  constant R : natural := 480; -- vertical rows(垂直行): 15.25 ms
  constant S : natural := 11;  -- rear guard: 0.35 ms
  constant O : natural := P + Q + R + S;  -- one vertical(垂直的) sync cycle: 16.6 ms
...
begin
  ...
  begin
    ...
    --8個LED外框設計
    if  row > 190 and row < 290 and column > 60 and column < 100  then --1
        if (btn=0000_0001) then
            red <= '1';
        else
            blue <= '1';
        end if;
    elsif row > 190 and row < 290 and column > 120 and column < 160  then --2
        if (btn=0000_0010) then
            red <= '1';
        else
            blue <= '1';
        end if;
    elsif row > 190 and row < 290 and column > 180 and column < 220  then --3
        if (btn=0000_0100) then
            red <= '1';
        else
            blue <= '1';
        end if;
    elsif row > 190 and row < 290 and column > 240 and column < 280  then --4    
        if (btn=0000_1000) then
            red <= '1';
        else
            blue <= '1';
        end if;
    elsif row > 190 and row < 290 and column > 360 and column < 400  then --5
        if (btn=0001_0000) then
            red <= '1';
        else
            blue <= '1';
        end if;
    elsif row > 190 and row < 290 and column > 420 and column < 460  then --6  
        if (btn=0010_0000) then
            red <= '1';
        else
            blue <= '1';
        end if;
    elsif row > 190 and row < 290 and column > 480 and column < 520  then --7
        if (btn=0100_0000) then
            red <= '1';
        else
            blue <= '1';
        end if;
    elsif  row > 190 and row < 290 and column > 540 and column < 580  then --8
        if (btn=1000_0000) then
            red <= '1';
        else
            blue <= '1';
        end if;
