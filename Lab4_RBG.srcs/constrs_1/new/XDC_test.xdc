...
#Raspberry Pi ¸}¦ì
set_property PACKAGE_PIN Y5 [get_ports Rout]
set_property PACKAGE_PIN W5 [get_ports Gout]
set_property PACKAGE_PIN AB10 [get_ports Bout]
set_property PACKAGE_PIN AB9 [get_ports H]
set_property PACKAGE_PIN AA6 [get_ports V]
